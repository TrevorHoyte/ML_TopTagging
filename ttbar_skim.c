...
int AnalyseEvents(ExRootTreeReader *treeReader, TestPlots *plots, int entrynumber)
{
    ...
    if (Drawplots > 0)
    {
        ...
        for (n = 0; n < jet->Constituents.GetEntriesFast(); ++n)
        {
            ...
            cout<<energy <<" , energy  , entry: "<<n<<endl;
        }
    ...
    if (Drawplots > 0)
    {
        ...
        char directory3[130];
        snprintf(directory3, sizeof(directory3), "/data/data065/thoyte/out/ML/trainning2/vect_ttbar/ptcuts%dxxxxx.txt", entrynumber);
        ofstream myfile;
...
void PrintHistograms(ExRootResult *result, TestPlots *plots, int entrynumber, int Drawplots)
{
    if (Drawplots == 1)
    {
        ...
        //snprintf(directory1, sizeof(directory1), "/data/data065/thoyte/out/ML/jet1/%dzznyzzynzz.jpg", entrynumber);
        snprintf(directory2, sizeof(directory2), "/data/data065/thoyte/out/ML/trainning2/ttbar/ptcuts%dxxxx.jpg", entrynumber);
...
//------------------------------------------------------------------------------
void ttbar_skim(const char *inputFile)
{
