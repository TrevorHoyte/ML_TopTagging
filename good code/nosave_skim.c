            ...
            if (Drawplots > 0)
            {
                ...
                for (j = 0; j < jet->Constituents.GetEntriesFast(); ++j)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if(j==hardest2){
                                cout<<" barebones  rapidity: "<< psuedo_rapidity<< "  ,phi angle:  "<<phi_angle<<endl;
                            }
                            ...
                            if(j==hardest2){
                                cout<<" translated->  rapidity: "<< psuedo_rapidity<< "  ,phi angle:  "<<phi_angle<<endl;
                            }
                            ...
                            if(j==hardest2){
                                cout<<"rotated -> rapidity: "<< psuedo_rapidity<< "  ,phi angle:  "<<phi_angle<<endl;
                            }
...
//------------------------------------------------------------------------------
void nosave_skim(const char *inputFile)
{
